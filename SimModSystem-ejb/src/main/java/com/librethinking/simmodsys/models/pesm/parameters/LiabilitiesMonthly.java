...
/**
 * This is a helper parameter that represents the monthly expenses, it is the sum of all the 
 * expenses applied in the month.
 * 
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class LiabilitiesMonthly extends PESMParameter  {
    public static final String NAME = "LIABILITIES.MONTHLY";
     ...
     * the Expenses of the Month. 
     * 
     * @return Collection of one Double object (with the current Sum of Expenses of the Month).
     */
    @Override
    ...
    /** Sets the value of the current Sum of Expenses by Liabilities in the Month. This is is similar to 
    ...
    /** Returns the current Status of this Parameter (e.g.: Disabled (currently 1) 
    ...
    /** Sets the current Status of this Parameter.
    ...
    /** Returns the MaxValue established for the Parameter.
    ...
    /** Returns the MinValue established for the Parameter.
    ...
    /** @returns true if the Parameter is unique (no repeatable), false otherwise.
     */
    @Override
    ...
    /** Returns the DefaultValue established for the Parameter.
     ...
     * 
     * @returns Sum of Expenses of the Month amount value.
     */   
     ...
     * 
     * @param amount with the Sum of Expenses of the Month value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        LiabilitiesMonthly myparam = (LiabilitiesMonthly) obj;
