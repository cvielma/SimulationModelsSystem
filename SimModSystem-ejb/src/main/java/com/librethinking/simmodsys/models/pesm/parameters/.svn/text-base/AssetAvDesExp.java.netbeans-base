...
/**
 * This class represents the Assets Available for Desired Expenses parameter. 
 * This is for the PESM (Personal Economy Simulation Model)
 *
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class AssetAvDesExp extends PESMParameter {
    public static final String NAME = "ASSET.AVDESEXP";
     ...
     * the Available Amount for Desired Expenses. 
     * 
     * @return Collection of one Double object (with the current Available Amount for Desired Expenses).
     */
    @Override
    ...
    /** Sets the value of the current Available Amount for Desired Expenses. This is is similar to 
    ...
    public boolean equals(Object obj){
        ...
        AssetAvDesExp myparam = (AssetAvDesExp) obj;
