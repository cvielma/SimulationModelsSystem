...
/**
 * This parameter represents the Annual Inflation, that affects the expenses.
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class ExpenseInflation extends PESMParameter {
    public static final String NAME = "EXPENSE.INFLATION";
...
/** Sets the current Status of this SIMParameter.
    ...
    public boolean equals(Object obj){
        ...
        ExpenseInflation myparam = (ExpenseInflation) obj;
