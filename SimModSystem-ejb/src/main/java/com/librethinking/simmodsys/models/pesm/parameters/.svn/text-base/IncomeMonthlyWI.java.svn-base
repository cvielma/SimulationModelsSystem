...
/**
 * This is a helper parameter that represents the monthly incomes, 
 * without counting the interests earned by assets. 
 * 
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class IncomeMonthlyWI extends PESMParameter {
    public static final String NAME = "INCOME.MONTHLYWI";
     ...
     * the Incomes of the Month. 
     * 
     * @return Collection of one Double object (with the current Sum of Incomes of the Month).
     */
    @Override
    ...
    /** Sets the value of the current Sum of Incomes of the Month. This is is similar to 
     ...
     * 
     * @returns Sum of Incomes of the Month amount value.
     */   
     ...
     * 
     * @param amount with the Sum of Incomes of the Month value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        IncomeMonthlyWI myparam = (IncomeMonthlyWI) obj;
