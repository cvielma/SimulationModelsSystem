...
/**
 * This Parameter represents the Money in the Accounts (Money in Bank) for the PESM 
 * (Personal Economy Simulation Model).
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class AssetAmount extends PESMParameter  {
    public static final String NAME = "ASSET.AMOUNT";
    public static final boolean UNIQUE = true;
    public static final double MINVALUE = -Double.MAX_VALUE;
    ...
    /** Sets the value of the current amount of the Asset. This is is similar to 
     ...
     * 
     * @param amount with the Asset Amount value.
     * 
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        AssetAmount myparam = (AssetAmount) obj;
