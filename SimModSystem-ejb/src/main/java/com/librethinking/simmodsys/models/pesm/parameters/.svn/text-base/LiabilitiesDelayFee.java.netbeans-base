...
/**
 * This parameter represents the late fee added to liabilities when not payed 
 * on time. This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class LiabilitiesDelayFee extends PESMParameter {
    public static final String NAME = "LIABILITIES.DELAYEDFEE";
     ...
     * the Liabilities Delayed Fee. 
     * 
     * @return Collection of one Double object (with the current amount of the Liabilities Delayed Fee).
     */
    @Override
    ...
    /** Sets the value of the current amount of the Liabilities Delayed Fee. This is is similar to 
     ...
     * 
     * @returns Liabilities Delayed Fee Amount value.
     */   
     ...
     * 
     * @param amount with the Liabilities Delayed Fee Amount value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        LiabilitiesDelayFee myparam = (LiabilitiesDelayFee) obj;
