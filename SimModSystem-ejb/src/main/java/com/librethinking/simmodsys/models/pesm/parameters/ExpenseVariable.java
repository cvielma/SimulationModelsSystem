...
/**
 * This parameter represents the monthly variable expenses that will be 
 * needed to be paid. 
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class ExpenseVariable extends PESMParameter {
    public static final String NAME = "EXPENSE.VAREXP";
    ...
    public Collection<Object> getValue() {
      ...
      * 
      * @param value shoud be a Collection of three Objects (String, Double, Double)
      * 
...
/** Sets the current Status of this SIMParameter.
    ...
    public boolean equals(Object obj){
        ...
        ExpenseVariable myparam = (ExpenseVariable) obj;
