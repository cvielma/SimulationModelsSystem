...
/**
 * This parameter represents the Desired Expenses, that are expenses
 * the user will like to do if Minimum Savings is reached.
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class ExpenseDesiredExpenses extends PESMParameter implements  Comparable{
    public static final String NAME = "EXPENSE.DESIREDEXP";
    public static final boolean UNIQUE = false;
    public static final Object[] MINVALUE = {"", "", 0.0, 0};
    public static final Object[] MAXVALUE = {"", "", Double.MAX_VALUE, Integer.MAX_VALUE};
    public static final Object[] DEFAULTVALUE = {"", "", 0.0, 0};
    public static final byte CATEGORYINDEX = 0;
    public static final byte DESCRIPTIONINDEX = 1;
    public static final byte AMOUNTINDEX = 2;
    public static final byte PRIORITYINDEX = 3;
    
    
    private int status = 1;
    private String category = (String) DEFAULTVALUE[CATEGORYINDEX];
    private String description = (String) DEFAULTVALUE[DESCRIPTIONINDEX];
    private double amount = (Double) DEFAULTVALUE[AMOUNTINDEX];
    private int priority = (Integer) DEFAULTVALUE[PRIORITYINDEX];
     ...
     * description, amount and priority.
     * 
     * @return Collection of four objects (String category, String description
     * Double amount, Integer priority).
     */
    @Override
    public Collection<Object> getValue() {
        Collection<Object> returnArray = new ArrayList<Object>();
        returnArray.add(this.getCategory());
        returnArray.add(this.getDescription());
        returnArray.add(this.getAmount());
        returnArray.add(this.getPriority());
        return returnArray;
    }

     /** Sets the value of the category, description, amount and priority at once. 
      * This is is similar to call independently {@link setCategory}, {@link setDescription}, 
      * {@link setAmount} and {@link setPriority}, but this is the general version to 
      * comply with the SIMParameter interface.
      * 
      * @param value shoud be a Collection of four Objects (String, String, Double, Integer)
      * 
    ...
    public void setValue(Collection<Object> value) {
        if(value==null){
            ...
            try{
                ...
                this.setDescription((String) value.toArray()[DESCRIPTIONINDEX]);                
                this.setAmount((Double) value.toArray()[AMOUNTINDEX]);                
                this.setPriority((Integer) value.toArray()[PRIORITYINDEX]);                                
            }
            catch(ClassCastException e){
                throw new ClassCastException("'"+NAME+"' expects a '[String, String, Double, Integer]' "
                        + "and passed value was of type: '["+ (value.toArray()[CATEGORYINDEX]).getClass().getName()+", "+
                        (value.toArray()[DESCRIPTIONINDEX]).getClass().getName()+", "+
                        (value.toArray()[AMOUNTINDEX]).getClass().getName()+", "+
                        (value.toArray()[PRIORITYINDEX]).getClass().getName()+"]'.");
            }            
        }
    }
...
/** Sets the current Status of this SIMParameter.
     ...
     * Because this parameter have four values for MaxValue, it will return a Collection 
     ...
     * Because this parameter have four values for MinValue, it will return a Collection 
     * with four values (String. String, Double, Integer).
     * 
     * @return Collection of (String. String, Double, Integer).
     */
    ...
    public boolean isUnique() {
     ...
     /** This method is convenience method to return the description associated without
    ...
    public void setDescription(String desc){
      if(desc!=null){
        this.description = desc;
           ...
           sb.append("Description passed: '").append(desc);
    ...
    /** This method is convenience method to return the priority associated without
     * having to cast the result. Note that this method isn't part of the interface.
     * 
     * @returns int with the priority.
     */   
    public int getPriority(){
      return this.priority;
    }
    
    /** This method is convenience method to set the priority associated without
     * having to cast the parameter or having to put it as a Collection.
     * Note that this method isn't part of the interface.
     * 
     * @param priority with the priority value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    public void setPriority(int priority){
    if(priority>= (Integer)this.MINVALUE[PRIORITYINDEX] && priority <= (Integer) this.MAXVALUE[PRIORITYINDEX]){
        this.priority = priority;
      }
       else{
           StringBuilder sb = new StringBuilder();
           sb.append("Priority passed: ").append(priority);
           sb.append(" is not in range: MIN ").append(this.MINVALUE[PRIORITYINDEX]);
           sb.append(" and MAX ").append(this.MAXVALUE[PRIORITYINDEX]);
           sb.append(".");
           throw new ValueOutOfBoundsException(sb.toString());
       }
    }
    ...
    public boolean equals(Object obj){
        ...
        ExpenseDesiredExpenses myparam = (ExpenseDesiredExpenses) obj;
        
        return myparam.getAmount() == this.getAmount() &&
                myparam.getCategory().equals(this.getCategory()) &&
                myparam.getDescription().equals(this.getDescription()) &&
                myparam.getPriority() == this.getPriority() &&                
    ...
    public int hashCode(){
        return (int) (this.getAmount() + this.getStatus() +
                this.getCategory().hashCode() + this.getDescription().hashCode()+
                this.getPriority());
    }
    ...
    public int compareTo(Object arg0) {
        return ((ExpenseDesiredExpenses) arg0).getPriority() - this.getPriority();
    }
