...
/**
 * This is a helper parameter that represents the yearly total of expenses. 
 * 
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class ExpenseYearly extends PESMParameter  {
    public static final String NAME = "EXPENSE.YEARLY";
     ...
     * 
     * @return Collection of one Double object (with the current Sum of Expenses of the Year).
     */
    @Override
    ...
    /** Sets the value of the current Sum of Expenses of the Year. This is is similar to 
     * {@link getAmount}, but this is the general version to comply with the
     * interface SIMParameter.
     * 
     * @param value should be a Collection of one Double. 
     * 
     ...
     * 
     * @returns Sum of Expenses of the Year amount value.
     */   
     ...
     * 
     * @param amount with the Sum of Expenses of the Year value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        ExpenseYearly myparam = (ExpenseYearly) obj;
