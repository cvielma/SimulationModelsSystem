...
/**
 * This parameter represents the minimum percentage required to pay every
 * month calculated over the liabilities.
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class LiabilitiesMinPayment extends PESMParameter  {
    
    public static final String NAME = "LIABILITIES.MINPAY";
     ...
     * the Liabilities Minimun Pay Percentage. 
     * 
     * @return Collection of one Double object (with the current amount of the 
     * Liabilities Minimun Pay Percentage).
     */
    @Override
    ...
    /** Sets the value of the current amount of the Liabilities Minimun Pay Percentage. This is is similar to 
    ...
    public boolean equals(Object obj){
        ...
        LiabilitiesMinPayment myparam = (LiabilitiesMinPayment) obj;
