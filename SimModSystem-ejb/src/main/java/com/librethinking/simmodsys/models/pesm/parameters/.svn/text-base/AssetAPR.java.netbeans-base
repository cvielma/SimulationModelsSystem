...
/**
  * This SIMParameter represents the positive interests that the
  * bank gives annually for an account.
  * (Personal Economy Simulation Model).
  * 
  * @author Christian Vielma <cvielma@librethinking.com>
 */
public class AssetAPR extends PESMParameter {
    
    public static final String NAME = "ASSET.APR";
     ...
     * the APR. 
     * 
     * @return Collection of one Double object (with the current amount of the APR).
     */
    @Override
    ...
    /** Sets the value of the current amount of the APR. This is is similar to 
     * {@link getPercentage}, but this is the general version to comply with the
    ...
    public String toString(){
        StringBuilder sb = new StringBuilder();
        sb.append("[Name: '").append(AssetAPR.NAME).append("', MinValue: ");
        sb.append(AssetAPR.MINVALUE).append(", MaxValue: ").append(AssetAPR.MAXVALUE);
        sb.append(", DefaultValue: ").append(AssetAPR.DEFAULTVALUE);
        sb.append(", Status: ").append(this.status).append(", PERCENTAGE: ");
