 ...
 */
public class IncomeYearly extends PESMParameter  {
    public static final String NAME = "INCOME.YEARLY";
     ...
     * the Incomes of the Year. 
     * 
     * @return Collection of one Double object (with the current Sum of Incomes of the Year).
     */
    @Override
    ...
    /** Sets the value of the current Sum of Incomes of the Year. This is is similar to 
     ...
     * 
     * @returns Sum of Incomes of the Year amount value.
     */   
     ...
     * 
     * @param amount with the Sum of Incomes of the Year value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        IncomeYearly myparam = (IncomeYearly) obj;
