...
/**
 * This class represents the Monthly Interests Earned parameter. Even when
 * this is an income, it is included in Assets because it is more involved with
 * Assets (modifies ASSET.AMOUNT and uses ASSET.APR).
 * 
 * This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class AssetMonthAPR extends PESMParameter  {
    public static final String NAME = "ASSET.MONTHAPR";
     ...
     * the Monthly Interests Earned. 
     * 
     * @return Collection of one Double object (with the current Monthly Interests Earned).
     */
    @Override
    ...
    /** Sets the value of the current Monthly Interests Earned. This is is similar to 
     ...
     * 
     * @returns Monthly Interests Earned amount value.
     */   
     ...
     * 
     * @param amount with the Monthly Interests Earned value.
     * @throws ValueOutOfBoundsException if value to be set is not between MINVALUE and MAXVALUE.
     */
    ...
    public boolean equals(Object obj){
        ...
        AssetMonthAPR myparam = (AssetMonthAPR) obj;
