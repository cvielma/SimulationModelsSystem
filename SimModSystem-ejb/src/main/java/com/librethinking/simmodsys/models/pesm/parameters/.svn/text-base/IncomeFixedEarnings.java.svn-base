...
/**
 * This parameter represents the monthly incomes that will receive the user 
 * in the Assets. This is for the PESM (Personal Economy Simulation Model)
 * 
 * @author Christian Vielma <cvielma@librethinking.com>
 */
public class IncomeFixedEarnings extends PESMParameter {
    public static final String NAME = "INCOME.FIXEDEARN";
    ...
    public Collection<Object> getValue() {
      ...
      * 
      * @param value should be a Collection of two Objects (String, Double)
      * 
...
/** Sets the current Status of this SIMParameter.
    ...
    public boolean equals(Object obj){
        ...
        IncomeFixedEarnings myparam = (IncomeFixedEarnings) obj;
